...
public class CustomerRegistrationServiceImpl implements CustomerRegistrationService {
    ...
    public CustomerRegistrationModel registerCustomer(CustomerRegistrationModel newCustomer) {
        ...
        return restTemplate.postForEntity(backendServerUrl + "/api/reg/customer", newCustomer, CustomerRegistrationModel.class).getBody();
    }

    @Override
    public CustomerRegistrationModel getCustomerProfile(String log, String pass) {
        RestTemplate restTemplate = new RestTemplate();
        CustomerRegistrationModel customerRegistrationModel = restTemplate.getForObject(backendServerUrl + "/api/reg/customer/login/" + log + "/password/" + pass, CustomerRegistrationModel.class);
